...
The [SshMixin](https://siliconlabs.github.io/mltk/docs/python_api/core/mltk_model.html#sshmixin) model mixin allows for defining model-specific SSH settings.
