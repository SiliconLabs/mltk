...
DOWNLOAD_URL = 'https://www.silabs.com/public/files/github/mltk/datasets/sl_synthetic_ten_digits.7z'
"""Public download URL"""
...
def download(
    dest_dir:str=None,
    dest_subdir='datasets/ten_digits',
...
def generate_dataset(out_dir:str=None):
    ...
    KEYWORDS = [
        Keyword('zero', max_count=10000),
        Keyword('one', max_count=10000),
        Keyword('two', max_count=10000),
        Keyword('three', max_count=10000),
        Keyword('four', max_count=10000),
        Keyword('five', max_count=10000),
        Keyword('six', max_count=10000),
        Keyword('seven', max_count=10000),
        Keyword('eight', max_count=10000),
        Keyword('nine', max_count=10000),
    ]
    ...
    out_dir = out_dir or create_user_dir('datasets/generated/ten_digits')
