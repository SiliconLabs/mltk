...
{
  0x4e, 0x3e, 0xce, 0x3f, 0x14, 0xec, 0x6c, 0x8f, 0xb9, 0x46, 0xd4, 0x4e, 0x91, 0xfe, 0x0f, 0xc2, 
};
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_20) = {
  .properties = 0x1a,
  .max_len = 16,
  .data = { 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, },
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0x4e, 0x3e, 0xce, 0x3f, 0x14, 0xec, 0x6c, 0x8f, 0xb9, 0x46, 0xd4, 0x4e, 0x90, 0xfe, 0x0f, 0xc2, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_10) = {
  .len = 14,
  .data = { 0x4d, 0x4c, 0x54, 0x4b, 0x20, 0x4b, 0x57, 0x53, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, }
};
