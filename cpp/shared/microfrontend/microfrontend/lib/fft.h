...
DLL_EXPORT void FftCompute(struct FftState* state, const int16_t* input,
                int input_scale_shift);

DLL_EXPORT void FftInit(struct FftState* state);

DLL_EXPORT void FftReset(struct FftState* state);
