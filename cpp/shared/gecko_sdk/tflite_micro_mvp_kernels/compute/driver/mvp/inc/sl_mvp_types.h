...
#define MVP_ARRAY_PTR(ptr) ((uint32_t)ptr)
#define MVP_SIMULATOR_EXECUTE()
...
#define MVP ((MVP_TypeDef*)sli_mvp_get_cmsis_instance())
#define MVP_ARRAY_PTR(ptr) sli_mvp_get_array_address((void*)ptr)
#define MVP_SIMULATOR_EXECUTE() sli_mvp_cmsis_execute()
